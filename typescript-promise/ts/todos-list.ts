...
class TodosList {
    ...
    constructor(public appView:AppView) {
        ...
        TodoStorage
            .find<Promise<Backendless.CollectionResultI>>(todosQuery)
            .then(function (result:Backendless.CollectionResultI):void {
    ...
    createItem(todo:TodoI):void {
        ...
        TodoStorage
            .save<Promise<TodoI>>(todoModel)
            .then(function (newItem:TodoI) {
